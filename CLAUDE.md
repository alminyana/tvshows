...
A follow-up pass (**D7**) reworked the `/series` view on top of that foundation: poster-first cards, a new **mosaic** density, filters out of the accordion, and a single categorical palette (`--cat-1..5`) shared by genre chips and KPI accents. See the D7 entry below.
